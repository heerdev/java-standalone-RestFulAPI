...
public class  DBSchema {
    ...
    public static final String customer="CREATE TABLE  CUSTOMERS (customer_id INTEGER  not null auto_increment, customer_name varchar(255), customer_info varchar(255),PRIMARY KEY (customer_id))";
    ...
    public static final String accounts="CREATE TABLE  ACCOUNTS (account_id INTEGER  not null auto_increment, customer_id INTEGER  not null,account_type_id INTEGER  not null,account_number varchar(20),balance float,PRIMARY KEY (account_id))";
    ...
    public static final String paymentTransaction="CREATE TABLE PAYMENT_TRANSACTION(pymt_txn_id INTEGER  not null auto_increment,cr_account INTEGER ,dr_account INTEGER , sender_ref varchar(255),txn_dt varchar(255) ,amount float ,currency varchar(255) , transfer_type varchar(255) , CrDr varchar(10),bic varchar(255),PRIMARY KEY (pymt_txn_id))";
